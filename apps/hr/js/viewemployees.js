function viewEmployees(){
	...
	for(var i = 0; i < arrayOfEmployeesObject.length; i++){
		...
		var row = "<tr><td> "+ employeeId + "</td> <td>"+ firstName +"</td> <td>"+ lastName +"</td> <td>"+ email +"</td> <td>"+ phoneNumber +"</td> <td>"+hireDate+"</td><td>"+salary+"</td><td>"+jobId+"</td><td>"+commisionPct+"</td><td>"+managerId+"</td><td>"+departmentId+"</td><td><input type = 'button' value = 'Edit'></td><td><input type = 'button' value = 'Delete'></td></tr>";
		rows = rows + row;	
	}
